...
def generate_launch_description():
    ...
    parameters={
          ...
          'RGBD/LinearUpdate': '0.1',  # Update map only if robot moves
          'RGBD/AngularUpdate': '0.1', # Update map only if robot turns
          'Rtabmap/TimeThr': '700',
    ...
    return LaunchDescription([
        ...
        # YOLO 3D Detector
        Node(
            package='perception', executable='yolo_3d_detector.py', output='screen',
